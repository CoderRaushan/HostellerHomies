...
const NoticeBoard = () => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', backgroundColor: '#f3e8ff', padding: 4 }}>
      {/* Header */}
      ...
      {notices.map((notice) => (
        ...
        >
          <CardContent>
            <Typography variant="h6" sx={{ color: '#4f46e5', fontWeight: 'bold' }} gutterBottom>
              {notice.title}
            </Typography>
      ...
      <Dialog open={open} onClose={() => setOpen(false)}>
        <DialogTitle sx={{ backgroundColor: '#4f46e5', color: 'white', fontWeight: 'bold' }}>
          Add New Notice
        </DialogTitle>
