...
function SecurityGuardSelector() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-xl shadow-lg mt-20">
      <h2 className="text-2xl font-bold mb-4 text-[#4f46e5]">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 mb-8">
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-[#4f46e5] text-white px-4 py-2 rounded hover:bg-[#4f46e5]"
        >
          {loading ? (editingId ? "Updating..." : "Adding...") : editingId ? "Update Guard" : "Add Guard"}
        </button>
        {editingId && (
          <button
            type="button"
            ...
            className="ml-2 px-4 py-2 rounded border border-gray-400 text-gray-700"
          >
            Cancel
          </button>
        )}
      ...
      <h3 className="text-xl font-semibold mb-2 text-[#4f46e5]">All Guards</h3>
