...
function RegisterStudent() {
  ...
  return (
    <div className="w-full min-h-screen bg-white text-black pt-20 flex flex-col items-center justify-center">
      ...
      <div className="max-w-4xl w-full p-10 bg-white rounded-lg shadow-xl">
        <form method="post" onSubmit={registerStudent} className="flex flex-col gap-5">
          ...
          <div>
            ...
            <textarea
              ...
              value={address}
              onChange={(e) => setAddress(e.target.value)}
              className="w-full p-3 bg-neutral-100 border rounded-md border-neutral-300 text-black focus:ring-2 focus:ring-[#4f46e5] outline-none"
            />
          </div>
