...
//   return (
//     <div className="py-5 px-5 flex items-center justify-between bg-white text-black w-full shadow-lg absolute top-0 md:w-[calc(100%-256px)] md:ml-[256px]">
//       <span className="hidden md:block">{date.toLocaleTimeString()}</span>

//       {/* Username with special color */}
...
//           <div className="absolute bg-white text-black -bottom-15 right-2 p-5 w-96 hidden group-hover:flex flex-col rounded-xl shadow-md">
//             <ul className="[&>*:nth-child(1)]:border-t-0">
//               {notifications.map((noti) => (
//                 <li
//                   key={noti}
//                   className="py-5 px-5 flex justify-between items-center text-md border-t-[1px] border-neutral-300 transition-all hover:bg-neutral-200 hover:rounded-xl hover:scale-105 hover:shadow-xl hover:border-transparent"
//                 >
//                   New account request from <span className="text-[#4f46e5]">{noti}</span>
...
//                       strokeWidth={1.5}
//                       stroke="black"
//                       className="w-5 h-5 hover:stroke-[#4f46e5] hover:scale-125 transition-all"
//                     >
//                       <path
//                         strokeLinecap="round"
//                         strokeLinejoin="round"
...
//                       />
//                     </svg>
//                     <span className="text-md hidden absolute w-32 -left-12 top-7 bg-white text-black text-center group-hover/edit:block rounded">
//                       Mark as read.
//                     </span>
//                   </span>
//                 </li>
...
//           <div className="absolute bg-white text-black -bottom-20 right-2 hidden group-hover:flex flex-col rounded shadow-md">
//             <Link to="settings" className="py-2 px-8 hover:bg-neutral-200">
//               Settings
//             </Link>
//             <Link to="/" className="py-2 px-8 hover:bg-neutral-200">
      ...
      <div className="flex gap-3">
        ...
        <Link to="settings">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-6 h-6 text-black hover:text-indigo-600 transition"
          >
            {/* Gear Icon */}
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c..."
            />
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
